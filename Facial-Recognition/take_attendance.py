...
attendance.print_attendance(attendance.students)
input("Press enter to take attendance...")
print("[INFO] scanning classroom for students...")
while(True):
	ret, frame = cap.read()
	...
	for(x,y,w,h) in faces:
		...
		if 45 <= conf:
			...
			attendance.mark_present(labels, id_)
